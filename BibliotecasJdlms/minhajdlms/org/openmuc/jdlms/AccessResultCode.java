...
public enum AccessResultCode {
	...
	static AccessResultCode forValue(long value) throws IllegalArgumentException {
		...
		throw new IllegalArgumentException(format("Unknown AccessResultCode for value %d.", value));
	}
}
