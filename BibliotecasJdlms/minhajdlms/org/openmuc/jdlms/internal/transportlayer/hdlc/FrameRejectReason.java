...
public class FrameRejectReason {
	...
	public FrameRejectReason(byte controlField) {
	...
	public static FrameRejectReason decode(byte[] data) throws IOException {
	...
	public enum RejectReason {
		...
		public static List<RejectReason> reasonsFor(byte bits) {
			List<RejectReason> reasons = new LinkedList<FrameRejectReason.RejectReason>();
