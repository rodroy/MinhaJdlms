...
public class HdlcAddressPair {
	...
	@Override
	public int hashCode() {
		int hashSource = source != null ? source.physcialDeviceAddress() + source.logicalDeviceAddress() : 0;
		int hashDestination = destination != null
				? destination.physcialDeviceAddress() + destination.logicalDeviceAddress() : 0;
