...
public class AE_qualifier {
	...
	public AE_qualifier_form2 ae_qualifier_form2 = null;
	...
	public AE_qualifier(AE_qualifier_form2 ae_qualifier_form2) {
	...
	public int encode(BerByteArrayOutputStream os, boolean explicit) throws IOException {
		...
		if (ae_qualifier_form2 != null) {
			codeLength += ae_qualifier_form2.encode(os, true);
			return codeLength;
	...
	public int decode(InputStream is, BerIdentifier berIdentifier) throws IOException {
		...
		if (berIdentifier.equals(BerOctetString.identifier)) {
			ae_qualifier_form2 = new AE_qualifier_form2();
			codeLength += ae_qualifier_form2.decode(is, false);
			return codeLength;
		}
	...
	public String toString() {
		if (ae_qualifier_form2 != null) {
			return "CHOICE{ae_qualifier_form2: " + ae_qualifier_form2 + "}";
		}
