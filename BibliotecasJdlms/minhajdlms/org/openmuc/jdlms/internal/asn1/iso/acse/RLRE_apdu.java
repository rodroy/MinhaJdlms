...
public class RLRE_apdu {
	...
	public Release_response_reason reason = null;
	...
	public RLRE_apdu(Release_response_reason reason, Association_information user_information) {
		id = identifier;
		this.reason = reason;
	...
	public int decode(InputStream is, boolean explicit) throws IOException {
		...
		if (berIdentifier.equals(BerIdentifier.CONTEXT_CLASS, BerIdentifier.PRIMITIVE, 0)) {
			reason = new Release_response_reason();
