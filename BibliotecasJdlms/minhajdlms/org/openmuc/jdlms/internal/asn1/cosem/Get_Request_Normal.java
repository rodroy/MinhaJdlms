...
public class Get_Request_Normal implements AxdrType {
	...
	public Get_Request_Normal() {
	}

	public Get_Request_Normal(byte[] code) {
		this.code = code;
	}

	public Get_Request_Normal(Invoke_Id_And_Priority invoke_id_and_priority,
	...
	public String toString() {
		return "sequence: {" + "invoke_id_and_priority: " + invoke_id_and_priority + ", cosem_attribute_descriptor: "
				+ cosem_attribute_descriptor + ", access_selection: " + access_selection + "}";
	}
