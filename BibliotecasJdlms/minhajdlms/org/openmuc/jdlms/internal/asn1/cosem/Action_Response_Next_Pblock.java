...
public class Action_Response_Next_Pblock implements AxdrType {
	...
	public Action_Response_Next_Pblock() {
	}

	public Action_Response_Next_Pblock(byte[] code) {
		this.code = code;
	}

	public Action_Response_Next_Pblock(Invoke_Id_And_Priority invoke_id_and_priority, Unsigned32 block_number) {
