...
public class TypeDescription implements AxdrType {
	...
	public static class SubSeq_array implements AxdrType {

		public byte[] code = null;
		public Unsigned16 number_of_elements = null;

		public TypeDescription type_description = null;
		...
		public SubSeq_array(Unsigned16 number_of_elements, TypeDescription type_description) {
		...
		public int encode(BerByteArrayOutputStream axdrOStream) throws IOException {
			...
			if (code != null) {
				...
				codeLength = 0;
				codeLength += type_description.encode(axdrOStream);

				codeLength += number_of_elements.encode(axdrOStream);
		...
		public int decode(InputStream iStream) throws IOException {
			...
			number_of_elements = new Unsigned16();
			codeLength += number_of_elements.decode(iStream);

			type_description = new TypeDescription();
			codeLength += type_description.decode(iStream);
		...
		public String toString() {
			return "sequence: {" + "number_of_elements: " + number_of_elements + ", type_description: "
					+ type_description + "}";
		}

	}

	public static class SubSeqOf_structure extends AxdrSequenceOf<TypeDescription> {
	...
	public AxdrNull bit_string = null;

	public AxdrNull double_long = null;

	public AxdrNull double_long_unsigned = null;

	public AxdrNull octet_string = null;

	public AxdrNull visible_string = null;

	public AxdrNull bcd = null;

	public AxdrNull integer = null;

	public AxdrNull long_integer = null;

	public AxdrNull unsigned = null;

	public AxdrNull long_unsigned = null;

	public AxdrNull long64 = null;

	public AxdrNull long64_unsigned = null;
	...
	public AxdrNull date_time = null;
	...
	public void setarray(SubSeq_array newVal) {
		resetChoices();
	...
	public void setbit_string(AxdrNull newVal) {
		resetChoices();
		choice = Choices.BIT_STRING;
		bit_string = newVal;
	}

	public void setdouble_long(AxdrNull newVal) {
		resetChoices();
		choice = Choices.DOUBLE_LONG;
		double_long = newVal;
	}

	public void setdouble_long_unsigned(AxdrNull newVal) {
		resetChoices();
		choice = Choices.DOUBLE_LONG_UNSIGNED;
		double_long_unsigned = newVal;
	}

	public void setoctet_string(AxdrNull newVal) {
		resetChoices();
		choice = Choices.OCTET_STRING;
		octet_string = newVal;
	}

	public void setvisible_string(AxdrNull newVal) {
		resetChoices();
	...
	public void setlong_integer(AxdrNull newVal) {
		resetChoices();
	...
	public void setlong_unsigned(AxdrNull newVal) {
		resetChoices();
	...
	public void setlong64_unsigned(AxdrNull newVal) {
		resetChoices();
	...
	public void setdate_time(AxdrNull newVal) {
		resetChoices();
