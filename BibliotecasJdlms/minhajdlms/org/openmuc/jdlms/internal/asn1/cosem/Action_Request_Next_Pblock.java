...
public class Action_Request_Next_Pblock implements AxdrType {
	...
	public Action_Request_Next_Pblock() {
	}

	public Action_Request_Next_Pblock(byte[] code) {
		this.code = code;
	}

	public Action_Request_Next_Pblock(Invoke_Id_And_Priority invoke_id_and_priority, Unsigned32 block_number) {
