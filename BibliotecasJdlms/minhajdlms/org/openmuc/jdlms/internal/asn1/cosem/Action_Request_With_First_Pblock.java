...
public class Action_Request_With_First_Pblock implements AxdrType {
	...
	public Action_Request_With_First_Pblock(byte[] code) {
		this.code = code;
	}

	public Action_Request_With_First_Pblock(Invoke_Id_And_Priority invoke_id_and_priority,
			Cosem_Method_Descriptor cosem_method_descriptor, DataBlock_SA pblock) {
	...
	public String toString() {
		return "sequence: {" + "invoke_id_and_priority: " + invoke_id_and_priority + ", cosem_method_descriptor: "
				+ cosem_method_descriptor + ", pblock: " + pblock + "}";
	}
