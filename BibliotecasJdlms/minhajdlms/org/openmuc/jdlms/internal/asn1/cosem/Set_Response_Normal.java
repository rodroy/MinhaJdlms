...
public class Set_Response_Normal implements AxdrType {
	...
	public Set_Response_Normal() {
	}

	public Set_Response_Normal(byte[] code) {
		this.code = code;
	}

	public Set_Response_Normal(Invoke_Id_And_Priority invoke_id_and_priority, AxdrEnum result) {
