...
public enum MethodResultCode {
	...
	private MethodResultCode(int value) {
		this.value = value;
	}
	...
	static MethodResultCode methodResultCodeFor(int value) {
		for (MethodResultCode e : MethodResultCode.values()) {
			if (e.value == value) {
				return e;
			}
		}
		throw new IllegalArgumentException("No method with result code value " + value + ".");
	}
}
